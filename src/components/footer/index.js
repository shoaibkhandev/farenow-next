...
import { Envelope, Facebook, Instagram, Twitter, Linkedin, Youtube } from 'react-bootstrap-icons';
            ...
            <Container>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-4">
                            <div className="mobile-app">
                                <h5>Flight &amp; Hotels in one place <span>Download our app now! Just a few clicks and you're done!</span>
                                </h5>
                                <a href="#" target="_self" className="ios">
                                </a>
                                <a href="#" target="_self" className="andriod">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div className="footer-bottom row no-gutters">
                    <ul className="nav col-md-4">
                        <li className="nav-item">
                            <a href="#" target="_self" className="nav-link">About Us</a>
                        </li>
                        <li className="nav-item">
                            <a href="#" target="_self" className="nav-link">Privacy Policy</a>
                        </li>
                        <li className="nav-item">
                            <a href="#" target="_self" className="nav-link">Terms of Use</a>
                        </li>
                        <li className="nav-item">
                            <a href="#" target="_self" className="nav-link">File a Claim</a>
                        </li>
                        <li className="nav-item">
                            <a href="#" target="_self" className="nav-link">Careers</a>
                        </li>
                    </ul>
