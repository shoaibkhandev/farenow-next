          ...
          <Row>
            <Col lg={7}>
              <div className="  section-heading mb-5">
                <h2 >Register with flyin</h2>{" "}
                <span > get following benefits</span>
              </div>
              <div className="list-group">
                <div className="list-group-item">
                  <svg
                    ...
                    fill="currentColor"
                    className="bi-check2-circle mr-3 b-icon bi"
                  >
                    <g >
                      <path
                        fillRule="evenodd"
                  ...
                  Special offers for Flights, Hotels, Flight+ Hotel &amp;
                  Holidays
                </div>{" "}
                <div className="list-group-item">
                  <svg
                    ...
                    focusable="false"
                    role="img"
                    aria-label="credit card2 front"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    className="bi-credit-card2-front mr-3 b-icon bi"
                  >
                    <g >
                      <path
                        fillRule="evenodd"
                ...
                <div className="list-group-item">
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    className="bi-bag-check mr-3 b-icon bi"
                  >
                    <g >
                      <path
                        fillRule="evenodd"
                ...
                <div className="list-group-item">
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    className="bi-card-checklist mr-3 b-icon bi"
                  >
                    <g >
                      <path
                        fillRule="evenodd"
                ...
                <div className="list-group-item">
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    className="bi-gift mr-3 b-icon bi"
                  >
                    <g >
                      <path
                        fillRule="evenodd"
                ...
                <div className="list-group-item">
                  <svg
                    ...
                    focusable="false"
                    role="img"
                    aria-label="credit card2 back"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    className="bi-credit-card2-back mr-3 b-icon bi"
                  >
                    <g >
                      <path
                        fillRule="evenodd"
